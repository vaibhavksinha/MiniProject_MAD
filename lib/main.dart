...
import 'package:projecttest/splash.dart';
import 'dart:convert';
...
class MyHomePage extends StatefulWidget {
  MyHomePage({key, required this.title, required this.email}) : super(key: key);
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List _customcompanies = [
    ...
    {"Company Name": "	Hero MotoCorp Limited.", "Symbol": "HEROMOTOCO"},
    {"Company Name": "	Titan Company Limited", "Symbol": "TITAN"},
    {"Company Name": "	Tata Consultancy Services Limited", "Symbol": "tcs"},
    {"Company Name": "State Bank of India", "Symbol": "SBIN"},
    {"Company Name": "Maruti Suzuki India Limited", "Symbol": "maruti"},
    {"Company Name": "Wipro Limited", "Symbol": "wipro"},
    {"Company Name": "	Larsen & Toubro Limited", "Symbol": "LT"},
    {"Company Name": "	ICICI Bank Limited", "Symbol": "ICICIBANK"},
  ];
